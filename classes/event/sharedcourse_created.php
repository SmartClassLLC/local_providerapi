 ...
 */
class sharedcourse_created extends \core\event\base {
    ...
    public static function create_from_objectid($id) {
        ...
        $data = array(
                ...
                'userid' => $course->sharedcoursecreaterid
    ...
    public static function get_name() {
        return get_string('createdsharedcourse', 'local_providerapi');
    }
