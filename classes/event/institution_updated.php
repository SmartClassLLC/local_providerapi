...
class institution_updated extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = institution::$dbname;
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('updatedinstitution', 'local_providerapi');
    }
    ...
    public function get_description() {
        ...
        $a->objname = 'institution';
        $a->objid = $this->objectid;
        return get_string('eventupdated', 'local_providerapi', $a);
    }
    ...
    public function get_url() {
        return new moodle_url('/local/providerapi/modules/institution/index.php');
