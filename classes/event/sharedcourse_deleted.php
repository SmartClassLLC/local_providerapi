 ...
 */
class sharedcourse_deleted extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = course::$dbname;
        $this->data['crud'] = 'd';
    ...
    public static function create_from_objectid($record) {
        ...
        $event->add_record_snapshot(course::$dbname, $record);
        return $event;
    }
    ...
    public static function get_name() {
        return get_string('deletedsharedcourse', 'local_providerapi');
    }
    ...
    public function get_url() {
        return new moodle_url('/local/providerapi/modules/course/index.php');
