...
$string['notexistcourseinbatch'] = 'The Course is not exist in batch';
$string['notexistrole'] = 'The roleshortname is not exist in moodle';
$string['notexistuser'] = 'The user is not exist in intitution';
...
$string['tasksyncgrades'] = 'Local Providerapi LTI tool grade sync';
